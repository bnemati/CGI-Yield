function [FLAM,Intensity] = fileImport(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [FLAM,INTENSITY] = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [FLAM,INTENSITY] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [FLAM,Intensity] = importfile('f5v.dat',2, 1157);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/05/24 11:45:15
