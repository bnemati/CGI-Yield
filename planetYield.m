% Issues needing further review
% 1.  calculation of mpix for all wavelengths for the IFS 

% Yield Model for WFIRST coronagraph based on contrast tables from John
% Krist and certain simplifying assumptions, as detailed in the
