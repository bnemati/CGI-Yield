function out = CircleZernike(npix, fraction, m, n)
%
%  out = CircleZernike(npix, fraction, m, n)
%
% Create a circular aperture centered within a npix * npix square array
% such that the entries within the aperture for a Zernike function of order
% n and frequency m, normalized to the range [-1,1] peak to peak.
%
% Uses function Zernfun by Paul Fricker  (Matlab Central Exchange)
%
% B. Nemati JPL 08-Feb-2007


delta = 2/npix;
[x, y] = meshgrid((-1+delta/2:delta:1-delta/2)/ fraction) ; 
...
out.Field = out.Mask .* exp(i * out.Phase);
