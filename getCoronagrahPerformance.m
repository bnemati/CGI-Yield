function CG = getCoronagrahPerformance(filename, startRow, endRow)
% Read coronagraph results file from John Krist's analysis
...
CG.rlamD = dataArray{:, 1};
CG.rarcsec = dataArray{:, 2};
CG.I = dataArray{:, 3};
CG.contrast1 = dataArray{:, 4};
CG.core_thruput = dataArray{:, 5};
CG.PSF_peak = dataArray{:, 6};
CG.areasq_arcs = dataArray{:, 7};
CG.ecocc_trans = dataArray{:, 8};
